...
if ($ADMIN->fulltree) {
    ...
    if (!function_exists('ldap_connect')) {
        ...
        $quickconfigurl = new moodle_url('/auth/casshib/quickconfig.php');
        $quickconfiglink = html_writer::link($quickconfigurl, get_string('capture_cas_settings', 'auth_casshib'));
        $settings->add(new admin_setting_heading('auth_casshib/quickconfig',
                new lang_string('quick_config', 'auth_casshib'), $quickconfiglink));
        // ENT ADDS.

        // CAS server configuration label.
        $settings->add(new admin_setting_heading('auth_cas/casserversettings',
                new lang_string('auth_casshib_server_settings', 'auth_cas'), ''));

        // Hostname.
        $settings->add(new admin_setting_configtext('auth_cas/hostname',
                get_string('auth_casshib_hostname_key', 'auth_cas'),
                get_string('auth_casshib_hostname', 'auth_cas'), '', PARAM_RAW_TRIMMED));

        // Base URI.
        $settings->add(new admin_setting_configtext('auth_cas/baseuri',
                get_string('auth_casshib_baseuri_key', 'auth_cas'),
                get_string('auth_casshib_baseuri', 'auth_cas'), '', PARAM_RAW_TRIMMED));

        // Port.
        $settings->add(new admin_setting_configtext('auth_cas/port',
                get_string('auth_casshib_port_key', 'auth_cas'),
                get_string('auth_casshib_port', 'auth_cas'), '', PARAM_INT));
        ...
        $settings->add(new admin_setting_configselect('auth_cas/casversion',
                new lang_string('auth_casshib_casversion', 'auth_cas'),
                new lang_string('auth_casshib_version', 'auth_cas'), CAS_VERSION_2_0, $casversions));
        ...
        $settings->add(new admin_setting_configselect('auth_cas/language',
                new lang_string('auth_casshib_language_key', 'auth_cas'),
                new lang_string('auth_casshib_language', 'auth_cas'), PHPCAS_LANG_ENGLISH, $CASLANGUAGES));
        ...
        $settings->add(new admin_setting_configselect('auth_cas/proxycas',
                new lang_string('auth_casshib_proxycas_key', 'auth_cas'),
                new lang_string('auth_casshib_proxycas', 'auth_cas'), 0 , $yesno));

        // Logout option.
        $settings->add(new admin_setting_configselect('auth_cas/logoutcas',
                new lang_string('auth_casshib_logoutcas_key', 'auth_cas'),
                new lang_string('auth_casshib_logoutcas', 'auth_cas'), 0 , $yesno));

        // Multi-auth.
        $settings->add(new admin_setting_configselect('auth_cas/multiauth',
                new lang_string('auth_casshib_multiauth_key', 'auth_cas'),
                new lang_string('auth_casshib_multiauth', 'auth_cas'), 0 , $yesno));

        // Server validation.
        $settings->add(new admin_setting_configselect('auth_cas/certificate_check',
                new lang_string('auth_casshib_certificate_check_key', 'auth_cas'),
                new lang_string('auth_casshib_certificate_check', 'auth_cas'), 0 , $yesno));

        // Certificate path.
        $settings->add(new admin_setting_configfile('auth_cas/certificate_path',
                get_string('auth_casshib_certificate_path_key', 'auth_cas'),
                get_string('auth_casshib_certificate_path', 'auth_cas'), ''));

        // CURL SSL version.
        $sslversions = array();
        $sslversions[''] = get_string('auth_casshib_curl_ssl_version_default', 'auth_cas');
        if (defined('CURL_SSLVERSION_TLSv1')) {
            $sslversions[CURL_SSLVERSION_TLSv1] = get_string('auth_casshib_curl_ssl_version_TLSv1x', 'auth_cas');
        }
        if (defined('CURL_SSLVERSION_TLSv1_0')) {
            $sslversions[CURL_SSLVERSION_TLSv1_0] = get_string('auth_casshib_curl_ssl_version_TLSv10', 'auth_cas');
        }
        if (defined('CURL_SSLVERSION_TLSv1_1')) {
            $sslversions[CURL_SSLVERSION_TLSv1_1] = get_string('auth_casshib_curl_ssl_version_TLSv11', 'auth_cas');
        }
        if (defined('CURL_SSLVERSION_TLSv1_2')) {
            $sslversions[CURL_SSLVERSION_TLSv1_2] = get_string('auth_casshib_curl_ssl_version_TLSv12', 'auth_cas');
        }
        if (defined('CURL_SSLVERSION_SSLv2')) {
            $sslversions[CURL_SSLVERSION_SSLv2] = get_string('auth_casshib_curl_ssl_version_SSLv2', 'auth_cas');
        }
        if (defined('CURL_SSLVERSION_SSLv3')) {
            $sslversions[CURL_SSLVERSION_SSLv3] = get_string('auth_casshib_curl_ssl_version_SSLv3', 'auth_cas');
        }
        $settings->add(new admin_setting_configselect('auth_cas/curl_ssl_version',
                new lang_string('auth_casshib_curl_ssl_version_key', 'auth_cas'),
                new lang_string('auth_casshib_curl_ssl_version', 'auth_cas'), '' , $sslversions));

        // Alt Logout URL.
        $settings->add(new admin_setting_configtext('auth_cas/logout_return_url',
                get_string('auth_casshib_logout_return_url_key', 'auth_cas'),
                get_string('auth_casshib_logout_return_url', 'auth_cas'), '', PARAM_URL));

        // ENT ADDS
        // No logout link.
        $settings->add(new admin_setting_configcheckbox('auth_casshib/nologoutnologoutatallforcasusers',
                get_string('auth_casshib_nologoutatallforcasusers', 'auth_casshib'),
                get_string('auth_casshib_nologoutatallforcasusers', 'auth_casshib'), '', PARAM_BOOL));

        $settings->add(new admin_setting_configcheckbox('auth_casshib/checklogoutclient',
                get_string('auth_casshib_checklogoutclient', 'auth_casshib'),
                get_string('auth_casshib_checklogoutclient', 'auth_casshib'), '', PARAM_BOOL));

        $settings->add(new admin_setting_configtext('auth_casshib/remotelogoutallowedclients',
                get_string('auth_casshib_remotelogoutallowedclients', 'auth_casshib'),
                get_string('auth_casshib_remotelogoutallowedclients', 'auth_casshib'), '', PARAM_TEXT));
        // /ENT ADDS

 ...
 * PHP Version 5
 *
 * @class    CASSHIB/ProxyTicketException.php
 ...
 *
 * @class    CASSHIB_ProxyTicketException
 * @category Authentication
 * @package  PhpCASSHIB
 * @author   Adam Franco <afranco@middlebury.edu>
 * @license  http://www.apache.org/licenses/LICENSE-2.0  Apache License 2.0
...
implements CASSHIB_Exception
{
     ...
     * @return void
     */
    public function __construct ($message, $code = PHPCASSHIB_SERVICE_PT_FAILURE)
    {
        ...
        if (!in_array($code, $ptCodes)) {
            trigger_error(
                'Invalid code '.$code
                .' passed. Must be one of PHPCASSHIB_SERVICE_PT_FAILURE, PHPCASSHIB_SERVICE_PT_NO_SERVER_RESPONSE, or PHPCASSHIB_SERVICE_PT_BAD_SERVER_RESPONSE.'
            );
        }

 ...
 * PHP Version 5
 *
 * @file     CASSHIB/Language/Catalan.php
 ...
 *
 * @class    CASSHIB_Languages_Catalan
 * @category Authentication
 * @package  PhpCASSHIB
 * @author   Iván-Benjamín García Torà <ivaniclixx@gmail.com>
 * @license  http://www.apache.org/licenses/LICENSE-2.0  Apache License 2.0
 ...
 */
class CASSHIB_Languages_Catalan implements CASSHIB_Languages_LanguageInterface
{
    /**
    ...
    */
    ...
    {
        return 'Autentificació CASSHIB necessària!';
    }
    ...
    */
    ...
    {
        return 'Sortida de CASSHIB necessària!';
    }
    ...
    */
    ...
    {
        return 'Ja hauria d\ haver estat redireccionat al servidor CASSHIB. Feu click <a href="%s">aquí</a> per a continuar.';
    }
    ...
    */
    ...
    {
        return 'Autentificació CASSHIB fallida!';
    }

 ...
 * PHP Version 5
 *
 * @file     CASSHIB/Language/Japanese.php
 ...
 *
 * @class    CASSHIB_Languages_Japanese
 * @category Authentication
 * @package  PhpCASSHIB
 * @author   fnorif <fnorif@yahoo.co.jp>
 * @license  http://www.apache.org/licenses/LICENSE-2.0  Apache License 2.0
 ...
 *
 **/
class CASSHIB_Languages_Japanese implements CASSHIB_Languages_LanguageInterface
{
    /**
    ...
    {
        return 'CASSHIB�����Ф˹Ԥ�ɬ�פ�����ޤ�����ưŪ��ž������ʤ����� <a href="%s">������</a> �򥯥�å�����³�Ԥ��ޤ��';
    }

 ...
 * PHP Version 5
 *
 * @file     CASSHIB/Language/Spanish.php
 ...
 *
 * @class    CASSHIB_Languages_Spanish
 * @category Authentication
 * @package  PhpCASSHIB
 * @author   Iván-Benjamín García Torà <ivaniclixx@gmail.com>
 * @license  http://www.apache.org/licenses/LICENSE-2.0  Apache License 2.0
 ...
 */
class CASSHIB_Languages_Spanish implements CASSHIB_Languages_LanguageInterface
{
    ...
    {
        return '¡Autentificación CASSHIB necesaria!';
    }
    ...
    {
        return '¡Salida CASSHIB necesaria!';
    }
    ...
    {
        return 'Ya debería haber sido redireccionado al servidor CASSHIB. Haga click <a href="%s">aquí</a> para continuar.';
    }
    ...
    {
        return '¡Autentificación CASSHIB fallida!';
    }

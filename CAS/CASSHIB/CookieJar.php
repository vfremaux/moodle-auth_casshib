...
class CASSHIB_CookieJar
{
    ...
    public function storeCookies ($request_url, $response_headers)
    {
        ...
        foreach ($cookies as $cookie) {
            ...
            phpCASSHIB::trace($cookie['name'].' -> '.$cookie['value']);
        }
    }
    ...
    protected function parseCookieHeader ($line, $defaultDomain)
    {
        ...
        phpCASSHIB::trace("Cookie Line: $line");
    ...
    protected function discardCookie ($cookie)
    {
        if (!isset($cookie['domain'])
            ...
            throw new CASSHIB_InvalidArgumentException('Invalid Cookie array passed.');
        }

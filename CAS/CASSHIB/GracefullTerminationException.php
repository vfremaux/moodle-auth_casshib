 ...
 * PHP Version 5
 *
 * @file     CASSHIB/GracefullTerminationException.php
 ...
 *
 * @class     CASSHIB_GracefullTerminationException.php
 * @category Authentication
 * @package  PhpCASSHIB
 * @author   Joachim Fritschi <jfritschi@freenet.de>
 * @author   Adam Franco <afranco@middlebury.edu>
...
class CASSHIB_GracefullTerminationException
...
implements CASSHIB_Exception
{
    ...
    /**
    * Force phpCASSHIB to thow Exceptions instead of calling exit()
    * Needed for unit testing. Generally shouldn't be used in production due to
    * an increase in Apache error logging if CASSHIB_GracefulTerminiationExceptions

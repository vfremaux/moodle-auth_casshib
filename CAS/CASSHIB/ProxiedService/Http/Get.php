 ...
 * PHP Version 5
 *
 * @file     CASSHIB/ProxiedService/Http/Get.php
 ...
 *
 *	try {
 *		$service = phpCASSHIB::getProxiedService(PHPCASSHIB_PROXIED_SERVICE_HTTP_GET);
 ...
 *          // (shouldn't happen) or CASSHIB server failure (unlikely)
 ...
 *	}
 *
 * @class    CASSHIB_ProxiedService_Http_Get
 * @category Authentication
 * @package  PhpCASSHIB
 * @author   Adam Franco <afranco@middlebury.edu>
 * @license  http://www.apache.org/licenses/LICENSE-2.0  Apache License 2.0
...
extends CASSHIB_ProxiedService_Http_Abstract
{
     ...
     *
     * @param CASSHIB_Request_RequestInterface $request request interface
     *
     * @return void
     */

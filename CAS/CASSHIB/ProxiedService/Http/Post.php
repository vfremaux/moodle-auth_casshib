 ...
 * PHP Version 5
 *
 * @file     CASSHIB/ProxiedService/Http/Post.php
 ...
 *
 *	try {
 * 		$service = phpCASSHIB::getProxiedService(PHPCASSHIB_PROXIED_SERVICE_HTTP_POST);
 ...
 *	}
 *
 * @class    CASSHIB_ProxiedService_Http_Post
 * @category Authentication
 * @package  PhpCASSHIB
 * @author   Adam Franco <afranco@middlebury.edu>
 * @license  http://www.apache.org/licenses/LICENSE-2.0  Apache License 2.0
 ...
 */
class CASSHIB_ProxiedService_Http_Post
extends CASSHIB_ProxiedService_Http_Abstract
{
     ...
     *
     * @param CASSHIB_Request_RequestInterface $request request interface class
     *
     * @return void
     */
    protected function populateRequest (CASSHIB_Request_RequestInterface $request)
    {

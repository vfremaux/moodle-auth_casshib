 ...
 * PHP Version 5
 *
 * @file     CASSHIB/OutOfSequenceBeforeClientException.php
 * @category Authentication
 * @package  PhpCASSHIB
 * @author   Joachim Fritschi <jfritschi@freenet.de>
 * @license  http://www.apache.org/licenses/LICENSE-2.0  Apache License 2.0
 * @link     https://wiki.jasig.org/display/Cas/phpCASSHIB
 */
 ...
 *
 * @class    CASSHIB_OutOfSequenceBeforeClientException
 * @category Authentication
 * @package  PhpCASSHIB
 * @author   Joachim Fritschi <jfritschi@freenet.de>
 * @license  http://www.apache.org/licenses/LICENSE-2.0  Apache License 2.0
 ...
 */
class CASSHIB_OutOfSequenceBeforeClientException
extends CASSHIB_OutOfSequenceException
implements CASSHIB_Exception
{
    ...
    {
        parent::__construct(
            'this method cannot be called before phpCASSHIB::client() or phpCASSHIB::proxy()'
        );
    }
}

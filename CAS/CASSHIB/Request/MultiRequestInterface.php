 ...
 * PHP Version 5
 *
 * @file     CASSHIB/Request/MultiRequestInterface.php
 ...
 * or in parallel.
 *
 * @class    CASSHIB_Request_MultiRequestInterface
 * @category Authentication
 * @package  PhpCASSHIB
 * @author   Adam Franco <afranco@middlebury.edu>
 * @license  http://www.apache.org/licenses/LICENSE-2.0  Apache License 2.0
 * @link     https://wiki.jasig.org/display/CASSHIBC/phpCASSHIB
 */
interface CASSHIB_Request_MultiRequestInterface
{
    ...
    *********************************************************/
     ...
     *
     * @return void
     * @throws CASSHIB_OutOfSequenceException If called after the Request has been
     * sent.

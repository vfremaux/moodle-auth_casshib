 ...
 * PHP Version 5
 *
 * @file     CASSHIB/Request/CurlRequest.php
 ...
 *
 * @class    CASSHIB_Request_CurlRequest
 * @category Authentication
 * @package  PhpCASSHIB
 * @author   Adam Franco <afranco@middlebury.edu>
 * @license  http://www.apache.org/licenses/LICENSE-2.0  Apache License 2.0
 ...
 */
class CASSHIB_Request_CurlRequest
extends CASSHIB_Request_AbstractRequest
implements CASSHIB_Request_RequestInterface
{
    ...
    protected function sendRequest ()
    {
        ...
        *********************************************************/
        $buf = curl_exec($ch);
        if ( $buf === false ) {
            phpCASSHIB::trace('curl_exec() failed');
            ...
            phpCASSHIB::trace("Response Body: \n".$buf."\n");
            $res = true;
    ...
    private function _initAndConfigure()
    {
        ...
        *********************************************************/
        if ($this->caCertPath) {
            ...
            phpCASSHIB::trace('CURL: Set CURLOPT_CAINFO ' . $this->caCertPath);
        } else {

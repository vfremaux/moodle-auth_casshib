 ...
 * PHP Version 5
 *
 * @file     CASSHIB/Request/AbstractRequest.php
 ...
 * or in parallel.
 *
 * @class    CASSHIB_Request_CurlMultiRequest
 * @category Authentication
 * @package  PhpCASSHIB
 * @author   Adam Franco <afranco@middlebury.edu>
 * @license  http://www.apache.org/licenses/LICENSE-2.0  Apache License 2.0
 ...
 */
class CASSHIB_Request_CurlMultiRequest
implements CASSHIB_Request_MultiRequestInterface
{
    ...
    *********************************************************/
     ...
     * class hierarchy.
     *
     * @param CASSHIB_Request_RequestInterface $request reqest to add
     *
     * @return void
     * @throws CASSHIB_OutOfSequenceException If called after the Request has been sent.
     * @throws CASSHIB_InvalidArgumentException If passed a Request of the wrong
     * implmentation.
     */
    public function addRequest (CASSHIB_Request_RequestInterface $request)
    {
        if ($this->_sent) {
        ...
        if (!$request instanceof CASSHIB_Request_CurlRequest) {
            throw new CASSHIB_InvalidArgumentException(
                'As a CASSHIB_Request_CurlMultiRequest, I can only work with CASSHIB_Request_CurlRequest objects.'
            );
        }

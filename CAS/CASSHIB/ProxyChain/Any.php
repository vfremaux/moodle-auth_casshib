 ...
 * PHP Version 5
 *
 * @file     CASSHIB/ProxyChain/Any.php
 ...
 */
class CASSHIB_ProxyChain_Any
implements CASSHIB_ProxyChain_Interface
{
    ...
    {
        phpCASSHIB::trace("Using CASSHIB_ProxyChain_Any. No proxy validation is performed.");
        return true;
    }

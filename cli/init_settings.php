...
if ($unrecognized) {
    ...
    echo "This option is not recognized: $unrecognized\n";
    exit(1);
}

if ($options['help']) {
    $help = "
Command line Moodle for snaping CASSHIB config from CAS config.
...
Example:
\$/usr/bin/php auth/casshib/cli/init_settings.php --host=http://my.virtual.moodle.org
...
echo "Starting snapping cas settings.\n";
